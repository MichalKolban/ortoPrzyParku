...
const StomatologiaPage = () => {
  ...
  return (
    <>
      <head>
        <title>
          Stomatologia | Ortodoncja Przy Parku w Szczecinie - Ortodoncja
          Szczecin | Stomatologia Szczecin
        </title>
        <meta
          name="description"
        ...
        <div className={styles.background}>
          <Section backgroundClass={"gray"}>
            <div className={styles.textBox}>
              ...
              <div className={styles.textContent}>
                Zabiegi chirurgiczne wykonywane przy użyciu nowoczesnych
                sprzętów i materiałów, dzięki czemu Pacjent może czuć się
                bezpiecznie i komfortowo, w trakcie zabiegu, jak i po nim.
                Niesiemy pacjentom profesjonalną pomoc nawet w najtrudniejszych
                przypadkach. Wykonujemy zabiegi dotyczące usuwania zębów,
                odsłaniania zębów zatrzymanych. Dodatkowo wykonujemy zabiegi
                przyspieszające leczenie ortodontyczne , czyli kortykotomie.
              </div>
            </div>
            <div className={styles.imageWrapper}></div>
          </Section>
          ...
          <Section backgroundClass={"gray"}>
            <div className={styles.textBox}>
              ...
              <div className={styles.textContent}>
                ...
                Podczas leczenia wykorzystywane są zaawansowane i nowoczesne
                techniki stomatologii cyfrowej, pozwala to na perfekcyjnie
                dopasowanie, trwałość i efekt estetyczny pracy.
              </div>
            </div>
            <div className={styles.imageWrapper}></div>
          </Section>
          ...
          <Section backgroundClass={"gray"}>
            <div className={styles.textBox}>
              ...
              <div className={styles.textContent}>
                ...
                oraz koloru zębów poprzez zastosowanie koron, licówek i
                bondingu.
              </div>
            </div>
            <div className={styles.imageWrapper}></div>
        ...
        <div className={styles.background}>
          <Section backgroundClass={"gray"}>
            <div className={styles.textBox}>
              ...
              <div className={styles.textContent}>
                Posiadamy pracownie radiologiczną wyposażoną w aparat
                rentgenowski wykonujący m.in. zdjęcie pantomograficzne,
                cefalometryczne oraz tomograf komputerowy. Badania rentgenowskie
                wykorzystywane są do diagnostyki i planowania zabiegów z zakresu
                chirurgii stomatologicznej, implantologii, protetyki,
                periodontologii, leczenia ortodontycznego oraz schorzeń stawów
