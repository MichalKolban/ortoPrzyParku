      ...
      <Section backgroundClass={"gray"}>
        <div className={styles.textBox}>
          ...
          <ul className={styles.equipmentList}>
            <li className={styles.textContent}>
              ...
              przezroczystych nakładek prostujących zęby, które są komfortowe i
              łatwe do utrzymania w czystości. Dzięki swojej budowie warunkują
              delikatne przesuwanie zębów, bez dyskomfortu i bólu. Nakładki
              wymienia się na nowe co 7-14 dni. Efekty stosowania systemu
              nakładkowego są doskonałe, a czas trwania terapii jest uzależniony
              od zaawansowania wady u konkretnego pacjenta. W naszym gabinecie
              stosujemy 3 rodzaje aparatów nakładkowych:
            </li>
        ...
        <div className={styles.textBox}>
          ...
          <div className={styles.textContent}>
            ...
            pacjenta oraz gdy ma uzębienie mieszane. Aparat powinien być noszony
            przez 14-16h na dobę. W niektórych przypadkach zalecone jest
            noszenie całodobowe aparatu ruchomego. Ortodonta określa minimalny
            czas noszenia. Aparaty zdejmowane są do jedzenia, picia i mycia
            zębów. Aby prawidłowo wyleczyć wadę zgryzu dziecko musi przestrzegać
            obowiązujących zasad stosowania aparatów ruchomych: czasu noszenia i
            sposobu korzystania z aparatu.
          </div>
          <div className={`${styles.title} ${styles.ortoTitle}`}>
            Mikroimplanty
          </div>
