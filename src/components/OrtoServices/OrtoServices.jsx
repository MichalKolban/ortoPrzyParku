...
export const OrtoServices = () => {
  const ortodoncjaIcon = "/icons/ortodoncja.png";
  const invisalignIcon = "/icons/invisalign.png";
  const skan3dIcon = "/icons/skan3d.png";
  const higienaJamyUstnejIcon = "/icons/higienaJamyUstnej.png";
  const endodoncjaIcon = "/icons/endodoncja.png";
  const protetykaIcon = "/icons/protetyka.png";
  const implantyIcon = "/icons/implanty.png";
  const stomatologiaZachowawczaIcon = "/icons/stomatologiaZachowawcza.png";
  const arroRightIcon = "/icons/arrowRightIcon.png";
